...
public class MemberDao {
    ...
    public List<Member> selectByRegdate(final LocalDateTime from, final LocalDateTime to) {
        final List<Member> result = jdbcTemplate.query(
                "select * from MEMBER where REGDATE between ? and ? order by REGDATE desc", memRowMapper, from, to);
        return result;
    }

    public Member selectById(final Long memId) {
